    ...
    <div className="min-h-screen flex items-center justify-center p-6"
      ...
      <div className="w-full max-w-md space-y-8 text-center">
        ...
        <div className="flex items-center justify-center gap-2.5">
          ...
          <span className="font-black text-xl tracking-tight" style={{ color: 'var(--c-97)' }}>
            BYNARI
          </span>
        </div>
        ...
        <div className="rounded-3xl p-8 space-y-6"
          ...
          <div className="space-y-3">
            ...
            <h1 className="text-2xl font-black" style={{ color: 'var(--c-97)' }}>
          ...
          <div className="rounded-2xl p-4 text-left space-y-2"
            style={{ background: 'var(--c-14)', border: '1px solid var(--c-w6)' }}>
            ...
            {[
              ...
              <div key={i} className="flex items-start gap-2.5">
                ...
                <p className="text-xs leading-relaxed" style={{ color: 'var(--c-60)' }}>{step}</p>
              </div>
            ))}
          </div>
