...
export default function EserciziPage() {
  ...
  const handleEdit = (e: Esercizio) => {
    setForm({ nome: e.nome, descrizione: e.descrizione ?? '', video_url: e.video_url ?? '', muscoli: e.muscoli ?? [] })
      ...
      {showForm && (
        <div className="rounded-2xl p-6 space-y-5"
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium" style={{ color: 'oklch(0.80 0 0)' }}>Nome <span style={{ color: 'oklch(0.70 0.19 46)' }}>*</span></label>
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium" style={{ color: 'oklch(0.80 0 0)' }}>Link video YouTube</label>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              {MUSCOLI_DISPONIBILI.map(muscolo => {
                ...
                return (
                  <button key={muscolo} onClick={() => toggleMuscolo(muscolo)}
        ...
        {loading ? (
          ...
          <div className="py-16 text-center space-y-3">
            ...
            <p className="text-sm" style={{ color: 'oklch(0.45 0 0)' }}>
              {search || filtroTipo !== 'tutti' || filtroMuscolo ? 'Prova a cambiare i filtri' : 'Crea il tuo primo esercizio'}
            </p>
          </div>
        ) : (
          <>
