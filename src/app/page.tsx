  ...
  return (
    <FadeIn delay={delay}>
      <div className="group relative p-6 rounded-2xl h-full transition-all duration-300 hover:-translate-y-1" style={{
        ...
        <h3 className="text-lg font-black mb-2 tracking-tight" style={{ color: 'var(--c-97)', fontFamily: 'Syne, sans-serif' }}>{title}</h3>
        <p className="text-sm leading-relaxed" style={{ color: 'var(--c-52)' }}>{body}</p>
      </div>
    </FadeIn>
  )
}
...
function MockDashboard() {
  return (
    <div className="relative w-full max-w-2xl mx-auto rounded-2xl overflow-hidden" style={{
      ...
      {/* Window bar */}
      <div className="flex items-center gap-2 px-4 py-3" style={{ borderBottom: '1px solid var(--c-w6)', background: 'var(--c-13)' }}>
        ...
        <div className="flex-1 mx-4 h-5 rounded-md" style={{ background: 'var(--c-20)' }} />
      </div>
      <div className="p-5 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-xs font-bold mb-1" style={{ color: 'var(--c-50)' }}>Buongiorno</div>
            <div className="text-lg font-black" style={{ color: 'var(--c-97)' }}>Dashboard Coach</div>
          </div>
        ...
        <div className="space-y-2">
          <div className="p-3 rounded-xl flex items-center gap-3" style={{ background: 'oklch(0.75 0.15 27 / 10%)', border: '1px solid oklch(0.75 0.15 27 / 25%)' }}>
            ...
            <div className="flex-1">
              ...
              <div className="text-xs mt-0.5" style={{ color: 'var(--c-50)' }}>Marco R. · Giulia T. · Andrea M.</div>
            </div>
          </div>
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={c.name} className="flex items-center gap-3 p-3 rounded-xl" style={{ background: 'var(--c-18)' }}>
              ...
              <div className="flex-1 min-w-0">
                <div className="text-xs font-bold" style={{ color: 'var(--c-90)' }}>{c.name}</div>
                <div className="text-xs" style={{ color: c.status === 'warning' ? 'oklch(0.75 0.15 27)' : 'var(--c-50)' }}>{c.days}</div>
              </div>
              <div className="w-16 h-1.5 rounded-full overflow-hidden" style={{ background: 'var(--c-25)' }}>
        ...
        <div className="grid grid-cols-3 gap-2">
          {[
            ...
            <div key={s.label} className="p-3 rounded-xl text-center" style={{ background: 'var(--c-18)' }}>
              <div className="text-xl font-black" style={{ color: 'oklch(0.70 0.19 46)' }}>{s.value}</div>
              <div className="text-xs mt-0.5" style={{ color: 'var(--c-45)' }}>{s.label}</div>
            </div>
          ))}
        </div>
      </div>
...
export default function LandingPage() {
  ...
  return (
    <div style={{ background: 'var(--c-11)', color: 'var(--c-97)', fontFamily: 'Syne, Inter, sans-serif', overflowX: 'hidden' }}>

      {/* ── NAV ── */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6"
        style={{
          background: 'var(--c-11a85)',
        ...
        <div className="hidden md:flex items-center gap-8">
          {[['Come funziona', '#come-funziona'], ['Per i Coach', '#coach'], ['Per gli Atleti', '#atleti'], ['Pricing', '#pricing']].map(([label, href]) => (
            <a key={label} href={href} className="text-sm font-medium"
              ...
              onMouseEnter={e => (e.currentTarget.style.color = 'var(--c-97)')}
              onMouseLeave={e => (e.currentTarget.style.color = 'var(--c-50)')}>
              {label}
            </a>
          ))}
        </div>
        <div className="flex items-center gap-3">
          <Link href="/login" className="hidden sm:block text-sm font-semibold px-4 py-2 rounded-xl"
            style={{ color: 'var(--c-55)' }}>Accedi</Link>
          <Link href="/register"
      ...
      <section className="relative overflow-hidden" style={{
        ...
        <div className="absolute inset-0" style={{
          backgroundImage: `linear-gradient(var(--c-w3) 1px, transparent 1px), linear-gradient(90deg, var(--c-w3) 1px, transparent 1px)`,
        ...
        <div ref={heroRef} className="relative z-10 px-6 max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed"
              style={{ color: 'var(--c-52)', fontFamily: 'Inter, sans-serif', fontWeight: 400 }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
              <Link href="/register"
                ...
                style={{ background: 'oklch(0.70 0.19 46)', color: 'var(--c-11)', minWidth: 240 }}>
              ...
              <Link href="/register"
                ...
                style={{ background: 'var(--c-18)', color: 'var(--c-97)', border: '1px solid var(--c-w12)', minWidth: 200 }}>
                Sono un Atleta
                <span className="transition-transform group-hover:translate-x-1">→</span>
              </Link>
            </div>
            <p className="text-xs" style={{ color: 'var(--c-35)', fontFamily: 'Inter, sans-serif' }}>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-32"
          style={{ background: 'linear-gradient(to bottom, transparent, var(--c-11))' }} />
      </section>

      {/* ── NUMERI ── */}
      <section className="py-12 px-6" style={{ borderTop: '1px solid var(--c-w6)', borderBottom: '1px solid var(--c-w6)' }}>
          ...
          {[
            ...
            <FadeIn key={s.label} delay={i * 0.1}>
              <div className="text-center">
                ...
                <p className="text-xs leading-snug" style={{ color: 'var(--c-40)', fontFamily: 'Inter, sans-serif' }}>{s.label}</p>
              </div>
            </FadeIn>
          ))}
        </div>
      ...
      {/* ── PROBLEMA ── */}
      <section className="py-24 px-6" style={{ background: 'var(--c-13)' }}>
        <div className="max-w-4xl mx-auto">
          <FadeIn>
            ...
            <h2 className="font-black tracking-tighter mb-6 leading-tight"
              ...
              <span style={{ color: 'var(--c-55)' }}>E di solito non capisci perché.</span>
            </h2>
          </FadeIn>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-10">
            {[
              ...
              <FadeIn key={item.title} delay={i * 0.1}> {/* Corretto: uso i invece di item.num */}
                <div className="p-6 rounded-2xl h-full" style={{ background: 'var(--c-16)', border: '1px solid var(--c-w7)' }}>
                  <div className="text-3xl mb-4">{item.icon}</div>
                  <h3 className="font-black text-base mb-2 tracking-tight" style={{ color: 'var(--c-97)', fontFamily: 'Syne, sans-serif' }}>{item.title}</h3>
                  <p className="text-sm leading-relaxed" style={{ color: 'var(--c-52)', fontFamily: 'Inter, sans-serif' }}>{item.body}</p>
                </div>
              </FadeIn>
            ))}
          </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn>
            ...
            <p className="text-base leading-relaxed mb-4" style={{ color: 'var(--c-52)', fontFamily: 'Inter, sans-serif' }}>
            ...
            <p className="text-base leading-relaxed" style={{ color: 'var(--c-52)', fontFamily: 'Inter, sans-serif' }}>
      ...
      {/* ── COME FUNZIONA ── */}
      <section id="come-funziona" className="py-24 px-6" style={{ background: 'var(--c-13)' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {STEPS.map((step, i) => (
              <FadeIn key={step.num} delay={i * 0.1}>
                <div className="relative p-6 rounded-2xl h-full" style={{ background: 'var(--c-16)', border: '1px solid var(--c-w7)' }}>
                  ...
                  <h3 className="font-black text-base mb-2 tracking-tight" style={{ color: 'var(--c-97)', fontFamily: 'Syne, sans-serif' }}>{step.title}</h3>
                  <p className="text-sm leading-relaxed" style={{ color: 'var(--c-52)', fontFamily: 'Inter, sans-serif' }}>{step.body}</p>
                </div>
              </FadeIn>
            ))}
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn>
            <div className="mb-14">
              ...
              <p className="text-base max-w-xl leading-relaxed" style={{ color: 'var(--c-50)', fontFamily: 'Inter, sans-serif' }}>
          ...
          <FadeIn delay={0.5}>
            <div className="mt-8 flex items-center gap-4">
              ...
              <span className="text-xs" style={{ color: 'var(--c-35)', fontFamily: 'Inter, sans-serif' }}>
      ...
      <section className="py-24 px-6" style={{ background: 'var(--c-13)' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="p-6 rounded-2xl h-full" style={{ background: 'oklch(0.70 0.19 46 / 6%)', border: '1px solid oklch(0.70 0.19 46 / 25%)' }}>
                ...
                {[
                  ...
                  <div key={item} className="flex items-start gap-3 mb-3">
                    ...
                    <p className="text-sm leading-relaxed" style={{ color: 'var(--c-70)', fontFamily: 'Inter, sans-serif' }}>{item}</p>
                  </div>
                ))}
              </div>
            </FadeIn>
            <FadeIn delay={0.2}>
              <div className="p-6 rounded-2xl h-full" style={{ background: 'var(--c-16)', border: '1px solid var(--c-w7)' }}>
                <p className="font-black text-sm mb-4 uppercase tracking-widest" style={{ color: 'var(--c-45)' }}>✗ Non è per te</p>
                {[
                  ...
                  <div key={item} className="flex items-start gap-3 mb-3">
                    <span className="mt-0.5 text-sm shrink-0" style={{ color: 'var(--c-45)' }}>✗</span>
                    <p className="text-sm leading-relaxed" style={{ color: 'var(--c-45)', fontFamily: 'Inter, sans-serif' }}>{item}</p>
                  </div>
                ))}
              </div>
            </FadeIn>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn>
            <div className="mb-14 text-right">
              ...
              <p className="text-base max-w-xl ml-auto leading-relaxed" style={{ color: 'var(--c-50)', fontFamily: 'Inter, sans-serif' }}>
          ...
          <FadeIn delay={0.4}>
            <div className="mt-8 flex items-center justify-end gap-4">
              <span className="text-xs" style={{ color: 'var(--c-35)', fontFamily: 'Inter, sans-serif' }}>Piano free · 1 scheda · 3 giorni</span>
              <Link href="/register"
                ...
                style={{ background: 'var(--c-18)', color: 'var(--c-97)', border: '1px solid var(--c-w15)' }}>
                Inizia gratis →
              </Link>
            </div>
          </FadeIn>
      ...
      {/* ── PRICING ── */}
      <section id="pricing" className="py-24 px-6" style={{ background: 'var(--c-13)' }}>
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn>
            ...
            <p className="text-base mb-12 leading-relaxed" style={{ color: 'var(--c-50)', fontFamily: 'Inter, sans-serif' }}>
            ...
            {[
              ...
              <FadeIn key={plan.name} delay={i * 0.1}>
                <div className="relative rounded-2xl p-6 h-full flex flex-col text-left"
                  style={{
                    background: plan.highlight ? 'oklch(0.70 0.19 46 / 8%)' : 'var(--c-16)',
                    border: `1px solid ${plan.highlight ? 'oklch(0.70 0.19 46 / 40%)' : 'var(--c-w7)'}`,
                  }}>
                  {plan.highlight && (
                  ...
                  <div className="mb-6">
                    ...
                    <span className="text-sm ml-2" style={{ color: 'var(--c-40)', fontFamily: 'Inter, sans-serif' }}>{plan.period}</span>
                  </div>
                  <ul className="space-y-2.5 flex-1 mb-6">
                    {plan.features.map(f => (
                      <li key={f} className="flex items-center gap-2.5 text-sm" style={{ color: 'var(--c-65)', fontFamily: 'Inter, sans-serif' }}>
                  ...
                  <a href={plan.href}
                    ...
                    style={{
                      background: plan.highlight ? 'oklch(0.70 0.19 46)' : 'var(--c-22)',
                      color: plan.highlight ? 'var(--c-11)' : 'var(--c-60)',
                      border: plan.highlight ? 'none' : '1px solid var(--c-w10)',
                    }}>
                    {plan.cta}
                  </a>
                </div>
          ...
          <FadeIn>
            <div className="relative p-10 md:p-16 rounded-3xl overflow-hidden" style={{
              ...
              <div className="relative z-10">
                ...
                <p className="text-base mb-10 leading-relaxed" style={{ color: 'var(--c-52)', fontFamily: 'Inter, sans-serif' }}>
                ...
                <p className="mt-5 text-xs" style={{ color: 'var(--c-35)', fontFamily: 'Inter, sans-serif' }}>
      ...
      {/* ── WAITLIST ── */}
      <section id="waitlist" className="py-24 px-6" style={{ background: 'var(--c-13)' }}>
        <div className="max-w-xl mx-auto text-center">
          <FadeIn>
            ...
            <p className="text-sm mb-8 leading-relaxed" style={{ color: 'var(--c-50)', fontFamily: 'Inter, sans-serif' }}>
            ...
            {submitted ? (
              <div className="px-6 py-4 rounded-2xl" style={{ background: 'oklch(0.65 0.18 150 / 15%)', border: '1px solid oklch(0.65 0.18 150 / 30%)' }}>
                ...
                <p className="text-sm mt-1" style={{ color: 'var(--c-50)', fontFamily: 'Inter, sans-serif' }}>Ti contatteremo non appena il piano sarà disponibile.</p>
              </div>
            ) : (
              <div className="flex flex-col sm:flex-row gap-3">
                <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                  ...
                  style={{ background: 'var(--c-16)', border: '1px solid var(--c-w10)', color: 'var(--c-97)', fontFamily: 'Inter, sans-serif' }}
                  onFocus={e => e.target.style.borderColor = 'oklch(0.70 0.19 46)'}
                  onBlur={e => e.target.style.borderColor = 'var(--c-w10)'}
      ...
      {/* ── FOOTER ── */}
      <footer className="py-10 px-6" style={{ borderTop: '1px solid var(--c-w6)' }}>
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <img src="/logo/Bynari_WO1.png" alt="Bynari" style={{ height: '22px', width: 'auto' }} />
            <span className="text-xs" style={{ color: 'var(--c-30)', fontFamily: 'Inter, sans-serif' }}>© 2026</span>
          </div>
          <div className="flex items-center gap-6">
            {[['Accedi', '/login'], ['Registrati', '/register'], ['Privacy Policy', '/privacy'], ['Termini di servizio', '/terms']].map(([label, href]) => (
              <Link key={label} href={href}
                ...
                style={{ color: 'var(--c-40)', fontFamily: 'Inter, sans-serif' }}>
                {label}
              </Link>
            ))}
          </div>
