  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <LineChart data={data} margin={{ top: 4, right: 4, left: -28, bottom: 0 }}>
        <XAxis dataKey="data" tick={{ fontSize: 10, fill: 'var(--c-45)' }} tickLine={false} axisLine={false} />
        <YAxis tick={{ fontSize: 10, fill: 'var(--c-45)' }} tickLine={false} axisLine={false} domain={['auto', 'auto']} />
        <Tooltip
